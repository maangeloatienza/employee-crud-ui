...
export default function UpdateModal({show,closeModal,handleUpdateEmployee,employee}){
            ...
            <div className="relative w-full h-full max-w-md p-4 md:h-auto mx-auto">
                <div className="relative bg-gray-100 rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="px-6 py-6 lg:px-8">
                         <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Update {employee.first_name + " " + employee.last_name}</h3>
