...
export default function DeleteModal({show,closeModal,handleDeleteEmployee,employee}){
    ...
    return <>
        ...
        {
            show? 
            <div id="popup-modal" tabIndex="-1" className="fixed top-0 left-0 right-0 z-50 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
                <div className="relative w-full h-full max-w-md p-4 md:h-auto mx-auto">
                    <div className="relative bg-gray-100 rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete {firstName+" "+ lastName}?</h3>
                            <button 
                                data-modal-toggle="popup-modal" 
                                type="button" 
